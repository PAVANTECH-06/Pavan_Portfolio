...
function initContactForm() {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    const subject = $("#cfSubject").value.trim() || "New message from portfolio";
    ...
    try {
      const res = await fetch(`https://formsubmit.co/ajax/${DATA.profile.email}`, {
        method: "POST",
      ...
      note.textContent = "Couldn't send directly — opening your email app instead.";
    } finally {
      btn.disabled = false;
